...
public class ChartUtil {
    ...
    public static Image getImage(List<Record> rs, int width, int height) {
        // Expense data from expense record
        double[] sampleValues = sampleValues(rs);
        // Date data from expense record
        ...
        // Set background red line
        chart.setValueLinesOn(true);
        // Set label
        chart.setSampleLabelsOn(true);
        // labels placed below x-axis
        ...
        // Legend text
        chart.setLegendLabels(new String[] { "Mo. Exp. Rpt." });
        // Legend font
    ...
    private static String[] sampleLabels() {
        ...
        for (int i = 0; i < sampleLabels.length; i++) {
            if (0 == i % 5)
                sampleLabels[i] = String.valueOf("Day" + i + 1);
        }
        return sampleLabels;
    }
    ...
    public static Image getImage(int width, int height) {
        ...
        chart.setLegendPosition(Chart.LEFT);
        //  
        chart.setLegendLabels(new String[] { "Month Expense Report" });
        //  
        chart.setFont("legendFont", new Font("Dialog", Font.BOLD, 13));
        //  
        chart.setFont("sampleLabelFont", new Font("Dialog", Font.BOLD, 13));
